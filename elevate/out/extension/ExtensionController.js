...
class ExtensionController {
    ...
    activateOpenFileListener(context) {
        const openFileListener = vscode.workspace.onDidOpenTextDocument(async (document) => {
            if (document.uri.scheme !== 'file')
                return;
            const ctx = new ElevateContext_1.ElevateContext(document);
